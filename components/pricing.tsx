...
const PricingCard = ({
  ...
  const [ref, isVisible] = useIntersectionObserver() as [React.RefObject<HTMLDivElement>, boolean];
  ...
  const handlePopup = async () => {
    if (isCurrentPlan || !planId) return; // Don't open checkout for current plan or if no planId
